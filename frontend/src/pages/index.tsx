...
export default function SvgSlider() {
  ...
  const categories = [
    ...
    { key: "home.categories.partTime" },
    { key: "home.categories.mba" },
    { key: "home.categories.engineering" },
    { key: "home.categories.media" },
    { key: "home.categories.design" },
    { key: "home.categories.dataScience" },
  ];
  // const internships = [
  //   {
  //     _id: "1",
  ...
  const slides = [
    {
      pattern: "pattern-1",
      titleKey: "home.slider.slide1",
      // title: "Start Your Career Journey",
      bgColor: "bg-indigo-600",
    },
    {
      pattern: "pattern-2",
      titleKey: "home.slider.slide2",
    ...
    },
    {
      ...
      titleKey: "home.slider.slide3",
      bgColor: "bg-purple-600",
    },
    {
      pattern: "pattern-4",
      //title: "Connect With Top Companies",
      titleKey: "home.slider.slide4",
      bgColor: "bg-teal-600",
    },
  ];
    ...
    const fetchdata = async () => {
      try {
        const [internshipres, jobres] = await Promise.all([
          axios.get("https://internshala-clone-zril.onrender.com/api/internship"),
          axios.get("https://internshala-clone-zril.onrender.com/api/job")
          ...
          <div className="flex flex-wrap gap-4">
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-4 py-2 rounded-full transition-colors ${selectedCategory === category.key
