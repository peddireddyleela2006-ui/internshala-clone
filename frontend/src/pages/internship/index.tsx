            ...
            <div className="hidden md:block w-64 bg-white rounded-lg shadow-sm p-6 h-fit">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-black">{t("intern.Filters")}</span>
                </div>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-center space-x-2">
                    ...
                    />
                    <span className="text-gray-700">{t("intern.WFH")}</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      ...
                      className="h-4 w-4 text-blue-600 rounded"
                    />
                    <span className="text-gray-700">{t("intern.PT")}</span>
                  </label>
                </div>
            ...
            <div className="flex-1">
              <div className="md:hidden mb-4">
                ...
                >
                  ...
                  <span> {t("intern.SF")}</span>
                </button>
              </div>
              <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                <p className="text-center font-medium text-black">
                  {filteredInternships.length} {t("intern.Internshipsfound")}
                </p>
              </div>
                ...
                {filteredInternships.map((internship: any) => (
                  ...
                  >
                    <div className="flex items-center space-x-2 text-blue-600 mb-4">
                      ...
                      <span className="font-medium">{t("intern.ActivelyHiring")}</span>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="flex items-center space-x-2 text-gray-600">
                        ...
                        <div>
                          <p className="text-sm font-medium">{t("intern.StartDate")}</p>
                      ...
                      <div className="flex items-center space-x-2 text-gray-600">
                        ...
                        <div>
                          <p className="text-sm font-medium">{t("intern.Location")}</p>
                      ...
                      <div className="flex items-center space-x-2 text-gray-600">
                        ...
                        <div>
                          <p className="text-sm font-medium">{t("intern.Stipend")}</p>
